...
// URIs:
:uri-qg-status: https://sonarcloud.io/dashboard?id=sc-sq-c-family-examples_linux-autotools-gitlab-ci-sc
:img-qg-status: https://sonarcloud.io/api/project_badges/measure?project=sc-sq-c-family-examples_linux-autotools-gitlab-ci-sc&metric=alert_status
:uri-build-status: https://gitlab.com/tomasz.kaminski/linux-autotools-gitlab-ci-sc/-/commits/main
...
*This project is analysed on https://sonarcloud.io/dashboard?id=sc-sq-c-family-examples_linux-autotools-gitlab-ci-sc[SonarCloud]!*
...
... Download the https://sonarcloud.io/documentation/analysis/languages/cfamily/#header-4[Build Wrapper]
